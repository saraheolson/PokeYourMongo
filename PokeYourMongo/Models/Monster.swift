...
class Monster {
    ...
    func randomMoveAction() -> SKAction {
        return SKAction.moveTo(randomPosition(), duration: 1.0)
    }
    ...
    static func allMonsters(screenHeight: UInt32, screenWidth: UInt32) -> [Monster] {
        
        let blueMonster = Monster(name: "BlueMonster",
                                  hitColor: UIColor.blueColor(),
                                  minX: 0,
                                  minY: 200,
                                  maxX: screenWidth,
                                  maxY: screenHeight)
        let purpleMonster = Monster(name: "PurpleMonster",
                                    hitColor: UIColor.purpleColor(),
                                    minX: 0,
                                    minY: 200,
                                    maxX: screenWidth,
                                    maxY: screenHeight)
        let blackMonster = Monster(name: "BlackMonster",
                                   hitColor: UIColor.blackColor(),
                                   minX: 0,
                                   minY: 200,
                                   maxX: screenWidth,
                                   maxY: screenHeight)
        let greenMonster = Monster(name: "GreenMonster",
                                   hitColor: UIColor.greenColor(),
                                   minX: 0,
                                   minY: 200,
                                   maxX: screenWidth,
                                   maxY: screenHeight)
